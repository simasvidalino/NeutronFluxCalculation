...
protected:
    ...
    virtual void writeintegratedNeutronFluxPerGroupPerRegion(dados_entrada *DDValues, CalculatedData *DDResult);
    ...
    virtual void writeAbsorptionRateFile(dados_entrada *DDValues, CalculatedData *DDResult);
